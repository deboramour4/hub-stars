...
extension UIFont {
    static let h1 = UIFont(name: "Montserrat-Semibold", size: 20)
    static let h2 = UIFont(name: "Montserrat-Regular", size: 17)
    static let h3 = UIFont(name: "Montserrat-SemiBold", size: 15)
    static let p1 = UIFont(name: "Montserrat-Regular", size: 17)
